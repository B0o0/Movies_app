...
class ApiRepository {
  static const String apiKey = 'e0177a6f31e74bd902e85b29c65fa4fb';
...
//---------------------------------------------------------------------------------------------------------------------------------------
  static Future<Movies> fetchMoviesData() async {
    var response = await http.get(
      Uri.parse(
          'https://api.themoviedb.org/3/movie/top_rated?api_key=e0177a6f31e74bd902e85b29c65fa4fb&language=en-US&page=1'),
    );
